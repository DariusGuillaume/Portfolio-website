...
{/* SOCIAL MEDIA ICONS */}
   ...
   <div className="md:hidden">
        ...
        > 
         ...
         {/* MENU */}
         {open && (
          <motion.div variants = {listVariants} initial = "closed" animate = "opened" className="absolute top-0 left-0 w-screen h-screen bg-nebulaBlue text-white flex flex-col items-center justify-center gap-8 text-4xl z-40">
            {links.map((link) => (
